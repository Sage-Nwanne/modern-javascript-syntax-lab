// ! Exercise 1: Applying the map() method
...
numsTimesTwo = nums.map((num) => num *2)

console.log(numsTimesTwo);


// ! Exercise 2: Deconstructing Arrays
...
// ! Exercise 3: Deconstructing objects
...
const userProfile = {[propertyName]: 'sage_nwanne'}

console.log(userProfile);



  // ! Exercise 7: importing and exporting files modern convention
//inside importingfile.js
  // *import* name, {computer, age,job} *from* './exportingfile.js'




  // ! Exercise 8: Default parameters (overriden parameters)
...
// ! Exercise 10: 
// ! 10.1 Set language && and operator- first falsy value, if both truthy returns last value ____  || or operator first truthy value, if both false returns last value\
//! falsey values: ('empty string' , 0, null, undefined,NaN, false)
